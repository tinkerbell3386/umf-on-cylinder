...
void epnp::add_correspondence(double X, double Y, double Z, double u, double v)
{
  ...
  //cout << "Added correspondence: [" << X << "," << Y << "," << Z << "] -> [" << u << "," << v << "] " << std::endl;
...
//  std::cout << "1: " << rep_errors[1] << std::endl;
//  for(int i = 0; i < 3; i++)
//  {
//      for(int j = 0; j < 3; j++)
//      {
...
//  std::cout << "2: " << rep_errors[2] << std::endl;
//  for(int i = 0; i < 3; i++)
//  {
//      for(int j = 0; j < 3; j++)
//      {
...
//  std::cout << "3: " << rep_errors[3] << std::endl;
//  for(int i = 0; i < 3; i++)
//  {
//      for(int j = 0; j < 3; j++)
//      {
...
//  std::cout << "abt_d " << std::endl;
//  for(int i = 0; i < 3; i++)
//  {
//      std::cout << abt_d[i] << ", ";
//  }
//  std::cout << std::endl<< "***abt_d" << std::endl;
...
//  std::cout << "dt " << dot(R[0], pw0) << " " << dot(R[1], pw0) << " " << dot(R[2], pw0) << std::endl;
//  std::cout << "Pw0: " << pws[0] << " " << pws[1] << " " << pws[2] << std::endl;
			       ...
			       double * betas)
{
  ...
  //std::cout << "L_6x4 " << std::endl;
  for(int i = 0; i < 6; i++) {
    cvmSet(&L_6x4, i, 0, cvmGet(L_6x10, i, 0));
    cvmSet(&L_6x4, i, 1, cvmGet(L_6x10, i, 1));
    cvmSet(&L_6x4, i, 2, cvmGet(L_6x10, i, 3));
    cvmSet(&L_6x4, i, 3, cvmGet(L_6x10, i, 6));
//    std::cout << cvmGet(&L_6x4, i, 0) << ", " << cvmGet(&L_6x4, i, 1) << ", " << cvmGet(&L_6x4, i, 2) << ", " << cvmGet(&L_6x4, i, 3) << std::endl;
  }
//  std::cout << "Rho " << std::endl;
//  for(int i = 0; i < 6; i++)
//  {
//      std::cout << cvmGet(Rho, i, 0) << ", ";
//  }
...
void epnp::quat_to_mat(const double q[4], double R[3][3])
{
...
void epnp::quat_to_euler(const double q[4], double e[3])
{
